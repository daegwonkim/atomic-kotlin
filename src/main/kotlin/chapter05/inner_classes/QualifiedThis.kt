package chapter05.inner_classes

import atomictest.eq
import chapter05.type_checking.name

/*
간단한 클래스에서 this의 의미는 분명해 보이지만, inner 클래스에서 this는 inner 객체나 외부 객체를 가리킬 수 있다.
이 문제를 해결하기 위해 코틀린에서는 한정된 this 구문을 사용한다. 한정된 this는 this 뒤에 @를 붙이고 대상 클래스 이름을 덧붙인 것이다.
 */
